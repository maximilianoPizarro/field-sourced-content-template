...
* Apicurio registra y versiona los schemas centralmente
...
Para usar Apicurio como serializer en Debezium, configurá el converter en KafkaConnect:
...
En esta demo, Apicurio usa `kafkasql` como backend: Apicurio almacena los schemas como mensajes en topics internos de Kafka. Ese diseño elimina una base de datos extra y hereda la replicación y durabilidad de Kafka (RF=3).
