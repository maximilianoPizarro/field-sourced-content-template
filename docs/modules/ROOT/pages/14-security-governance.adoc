...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/authentication_and_authorization/index[OpenShift Authentication and Authorization^] — OAuth, OIDC y RBAC en OpenShift
...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/networking/network-policy[OpenShift Network Policies^] — Seguridad de red a nivel de namespace
