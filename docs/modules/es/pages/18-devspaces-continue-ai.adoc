...
Un `devfile.yaml` define cada workspace: contenedor, extensiones y tareas de inicio:
...
Accedé a Developer Hub: `https://backstage-developer-hub-developer-hub.{cluster_domain}`
...
| Recargá el navegador con F5 — `postStart` instala las extensiones y requieren recarga
...
* xref:17-ai-playground-kafka-mcp.adoc[AI Playground + Kafka MCP]
