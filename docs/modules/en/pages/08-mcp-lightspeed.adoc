...
. MCP injects the results (resource YAML, logs, events) back into the model context.
...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/cli_tools/oc-cli-getting-started[OpenShift CLI (oc)^] — Command-line tool for OpenShift
