...
[.lead]
OpenShift AI 3.3 includes *Gen AI Studio* (Playground) so you can chat with deployed LLMs. Combined with the *Kafka MCP Server* that Kuadrant's MCP Gateway registers, the Playground becomes an AI agent that can query live Kafka data.
...
* xref:16-neuroface-cv.adoc[NeuroFace CV Pipeline]
