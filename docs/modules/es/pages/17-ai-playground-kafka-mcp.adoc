...
[.lead]
OpenShift AI 3.3 incluye *Gen AI Studio* (Playground) para que interactúes con LLM desplegados. Combinado con el *Kafka MCP Server* que registra el MCP Gateway de Kuadrant, el Playground se convierte en un agente de IA que consulta datos Kafka en vivo.
...
* xref:16-neuroface-cv.adoc[Pipeline CV NeuroFace]
