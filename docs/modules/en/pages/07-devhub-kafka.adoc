...
Developer Hub loads the plugin as a dynamic plugin:
...
Developer Hub mounts the frontend conditionally on entity pages:
...
Open: `https://kafka-console-kafka-cdc.{cluster_domain}`
