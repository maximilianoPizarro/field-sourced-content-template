...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/cli_tools/oc-cli-getting-started[OpenShift CLI (oc)^] — Comandos para verificación operativa
