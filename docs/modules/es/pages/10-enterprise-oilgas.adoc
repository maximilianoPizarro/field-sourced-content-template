...
El mismo patrón CDC de este workshop aplica directo a escenarios de misión crítica en Oil and Gas, donde sensores IoT y sistemas SCADA generan datos continuos que el pipeline procesa en tiempo real.
...
. Paralelamente, el pipeline persiste todos los eventos (normales y anómalos) en un *Data Lake* (S3/ODF) para análisis histórico y entrenamiento de modelos ML.
...
* https://docs.redhat.com/en/documentation/openshift_container_platform/4.21[Red Hat OpenShift Container Platform^] — Plataforma de despliegue edge y cloud
