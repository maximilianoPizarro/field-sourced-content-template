...
image::ROOT:edge-manufacturing-overview.png[Industrial Edge solution overview,align=center]
...
image::ROOT:industrial-edge-logical.png[Industrial Edge logical architecture,align=center]

_Figure 2. Industrial Edge solution as logically and physically distributed across multiple sites._

=== Overall Data Flows

image::ROOT:edge-mfg-data-flow.png[Overall data flows,align=center]
...
image::ROOT:edge-mfg-messaging-ml.png[Edge manufacturing with messaging and ML,align=center]
...
image::ROOT:edge-mfg-gitops.png[GitOps workflows,align=center]
...
image::ROOT:highleveldemo.png[High-level demo scenario,align=center]
